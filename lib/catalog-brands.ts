...
const rawCatalogBrands: CatalogBrand[] = [
  {
    ...
    tagline: {
      ...
      pl: "Actros, Atego i Arocs do transportu dalekobieżnego, regionalnego i budowlanego.",
    },
    highlights: {
    ...
    overview: {
      ...
      pl: "Mercedes-Benz należy do liderów europejskiego transportu komercyjnego. Pracujemy z pojazdami Mercedes-Benz w różnych konfiguracjach — od ciągników siodłowych po specjalistyczne podwozia, zabudowy skrzyniowe i pojazdy kontenerowe.",
    },
    ...
    bodyTypes: {
      ...
      pl: ["Ciągniki Actros dalekobieżne (4x2, 6x2)", "Podwozia dystrybucyjne i budowlane Arocs"],
    },
    configurations: {
      ...
      pl: ["Kabiny sypialne GigaSpace i StreamSpace", "Skrzynie PowerShift i manualne", "Predictive Powertrain Control i telematyka flotowa"],
    },
    typicalSpecs: {
      ...
      pl: ["Moc silnika od 420 do 530 KM", "Konfiguracja pod flotę", "Pełne zawieszenie pneumatyczne i hamulce tarczowe", "Przegląd stanu przed przekazaniem"],
    },
  },
  {
    id: "man",
    ...
    tagline: {
      ...
      pl: "Ciągniki dalekobieżne i dystrybucyjne z linii TGX i TGS.",
    },
    highlights: {
      en: ["TGX", "TGS", "Fleet"],
      uk: ["TGX", "TGS", "Автопарк"],
    ...
    overview: {
      ...
      pl: "MAN należy do liderów europejskiego transportu komercyjnego. Pracujemy z pojazdami MAN w różnych konfiguracjach — od ciągników siodłowych po specjalistyczne podwozia, zabudowy skrzyniowe i pojazdy kontenerowe.",
    },
    ...
    bodyTypes: {
      ...
      pl: ["Ciągniki siodłowe (4x2, 6x2)", "Podwozia pod specjalne zabudowy"],
    },
    configurations: {
      ...
      pl: ["Kabiny sypialne XLX / GX", "Skrzynie automatyczne i manualne", "Retarder i opcje telematyki flotowej"],
    },
    typicalSpecs: {
      ...
      pl: ["Moc silnika od 400 do 510 KM", "Konfiguracja pod flotę", "Zawieszenie pneumatyczne i hamulce tarczowe", "Kluczowe informacje o stanie"],
    },
  },
  {
    id: "scania",
    ...
    tagline: {
      ...
      pl: "Ciągniki serii R i S do efektywnego transportu dalekobieżnego.",
    },
    highlights: {
      ...
      pl: ["R-series", "S-series", "Opticruise"],
    },
    overview: {
      ...
      pl: "Scania należy do liderów europejskiego transportu komercyjnego. Pracujemy z pojazdami Scania w różnych konfiguracjach — od ciągników siodłowych po specjalistyczne podwozia, zabudowy skrzyniowe i pojazdy kontenerowe — dla potrzeb flot firmowych.",
    },
    ...
    bodyTypes: {
      ...
      pl: ["Ciągniki z kabiną wysoką i standardową", "Układy osi 6x2 i 4x2"],
    },
    configurations: {
      ...
      pl: ["Skrzynia Opticruise", "Retarder i adaptacyjny tempomat", "P-disc i kabiny z zawieszeniem pneumatycznym"],
    },
    typicalSpecs: {
      ...
      pl: ["Zakres mocy 450–500 KM", "Niska lub standardowa wysokość siodła", "Konfiguracja pod flotęs", "Opcje współpracy gotowe do biznesu"],
    },
  },
  {
    id: "daf",
    ...
    tagline: {
      ...
      pl: "Ciągniki XF i CF zaprojektowane z myślą o oszczędności paliwa i komforcie kierowcy.",
    },
    highlights: {
      en: ["XF", "CF", "Fleet"],
      uk: ["XF", "CF", "Автопарк"],
    ...
    overview: {
      ...
      pl: "DAF należy do liderów europejskiego transportu komercyjnego. Pracujemy z pojazdami DAF w różnych konfiguracjach — od ciągników siodłowych po specjalistyczne podwozia, zabudowy skrzyniowe i pojazdy kontenerowe.",
    },
    ...
    bodyTypes: {
      ...
      pl: ["Ciągniki XF dalekobieżne", "Podwozia dystrybucyjne i regionalne CF"],
    },
    configurations: {
      ...
      pl: ["Kabiny Super Space Cab i sypialne", "Zakres silników PACCAR MX", "Pakiet adaptive cruise i asystenta pasa ruchu"],
    },
    typicalSpecs: {
      ...
      pl: ["Typowy zakres 430–530 KM", "Konfiguracja pod flotę", "Zawieszenie pneumatyczne", "Kluczowe parametry techniczne"],
    },
  },
  {
    id: "volvo",
    ...
    tagline: {
      ...
      pl: "Ciągniki FH i FM z I-Shift dla nowoczesnych flot europejskich.",
    },
    highlights: {
      en: ["FH", "FM", "I-Shift"],
      uk: ["FH", "FM", "I-Shift"],
    ...
    overview: {
      ...
      pl: "Volvo należy do liderów europejskiego transportu komercyjnego. Pracujemy z pojazdami Volvo w różnych konfiguracjach — od ciągników siodłowych po specjalistyczne podwozia, zabudowy skrzyniowe i pojazdy kontenerowe.",
    },
    ...
    bodyTypes: {
      ...
      pl: ["Ciągniki FH dalekobieżne", "Podwozia regionalne i budowlane FM"],
    },
    configurations: {
      ...
      pl: ["Kabiny Globetrotter i sypialne", "Automatyczna skrzynia I-Shift", "Opcje Volvo Dynamic Steering"],
    },
    typicalSpecs: {
      ...
      pl: ["Typowy zakres 420–500 KM", "Konfiguracja pod flotę", "Zawieszenie pneumatyczne on all axles", "Przegląd stanu przed przekazaniem"],
    },
  },
  {
    id: "renault",
    ...
    tagline: {
      ...
      pl: "Ciągniki z linii T i C do wszechstronnych operacji transportowych w Europie.",
    },
    highlights: {
      en: ["T High", "T", "C"],
      uk: ["T High", "T", "C"],
    ...
    overview: {
      ...
      pl: "Renault Trucks należy do liderów europejskiego transportu komercyjnego. Pracujemy z pojazdami Renault w różnych konfiguracjach — od ciągników siodłowych po specjalistyczne podwozia, zabudowy skrzyniowe i pojazdy kontenerowe.",
    },
    ...
    bodyTypes: {
      ...
      pl: ["Ciągniki T High dalekobieżne", "Ciągniki dystrybucyjne T", "Podwozia budowlane C"],
    },
    configurations: {
      ...
      pl: ["Automatyczna skrzynia Optidriver", "Warianty kabin sleeper i day cab", "Pakiety telematyki flotowej"],
    },
    typicalSpecs: {
      ...
      pl: ["Typowy zakres 440–520 KM", "Konfiguracja pod flotę", "Zawieszenie pneumatyczne on drive axles", "Przegląd stanu przed przekazaniem"],
    },
  },
  {
    id: "schmitz",
    ...
    tagline: {
      ...
      pl: "Naczepy Cargobull do transportu plandekowego, skrzyniowego i chłodniczego.",
    },
    highlights: {
    ...
    overview: {
      ...
      pl: "Schmitz Cargobull to wiodący europejski producent naczep. Pracujemy z naczepami skonfigurowanymi do ładunków ogólnych, towarów w kontrolowanej temperaturze i logistyki flotowej.",
    },
    bodyTypes: {
      ...
      pl: ["Plandeka (S.KO)", "Naczepy skrzyniowe", "Chłodnicze S.KO COOL"],
    },
    configurations: {
      ...
      pl: ["Opcje osi podnoszonej i skrętnej", "Warianty XL code i pojemności paletowej", "Hamulce tarczowe i gotowość na telematykę"],
    },
    typicalSpecs: {
      ...
      pl: ["Układ 3-osowy", "Podłoga i ściany zoptymalizowane pod ładunek", "Zawieszenie BPW lub SAF", "Opcje osi i hamulców"],
    },
  },
  {
    id: "krone",
    ...
    tagline: {
      ...
      pl: "Naczepy do transportu suchego, plandekowego i skrzyniowego w europejskiej logistyce.",
    },
    highlights: {
      ...
      pl: ["Profi Liner", "Dry Liner", "Box Liner"],
    },
    overview: {
      ...
      pl: "Naczepy Krone są powszechnie używane w europejskich sieciach transportowych. Pracujemy z modelami odpowiednimi do ładunków suchych, operacji plandekowych i mieszanych wymagań flotowych.",
    },
    bodyTypes: {
      ...
      pl: ["Plandeka Profi Liner", "Transport suchy Dry Liner", "Box Liner ze wzmocnioną podłogą"],
    },
    configurations: {
      ...
      pl: ["Opcje wysokości standardowej i Mega", "Konfiguracje z osią podnoszoną", "Konfiguracje Multi-lock i XL"],
    },
    typicalSpecs: {
      ...
      pl: ["Typowa naczepa 3-osowa", "Opcje ścian aluminiowych lub stalowych", "Systemy hamulców tarczowych", "Kluczowe parametry techniczne"],
    },
  },
  {
    id: "koegel",
    ...
    tagline: {
      ...
      pl: "Lekkie naczepy i przyczepy do wszechstronnych profili ładunkowych.",
    },
    highlights: {
      ...
      pl: ["Cargo", "Port", "Lekka konstrukcja"],
    },
    overview: {
      ...
      pl: "Kögel oferuje praktyczne rozwiązania naczepowe z naciskiem na ładowność i ekonomikę eksploatacji. Pracujemy z konfiguracjami plandekowymi, skrzyniowymi i platformowymi dla flot europejskich.",
    },
    bodyTypes: {
      ...
      pl: ["Plandeka Cargo", "Naczepy skrzyniowe i portowe", "Platformy i naczepy niskopodwoziowe"],
    },
    configurations: {
      ...
      pl: ["Opcje lekkich podwozi", "Wielokomorowe chłodnie tam, gdzie stosowne", "Indywidualne pakiety osi i hamulców"],
    },
    typicalSpecs: {
      ...
      pl: ["Zoptymalizowana masa własna", "Typowa europejska wysokość sprzęgu", "Osie BPW / SAF", "Podsumowanie stanu przed przekazaniem"],
    },
  },
  {
    id: "wielton",
    ...
    tagline: {
      ...
      pl: "Polskie naczepy do operacji plandekowych, wywrotek i platformowych.",
    },
    highlights: {
      en: ["NS3", "NW3", "Tipper"],
      uk: ["NS3", "NW3", "Самоскид"],
    ...
    overview: {
      ...
      pl: "Wielton jest jednym z największych producentów naczep w Europie. Pracujemy z modelami plandekowymi, wywrotkami i platformowymi skonfigurowanymi do ładunków ogólnych i logistyki budowlanej.",
    },
    bodyTypes: {
      ...
      pl: ["Plandeka NS3/NW3", "Naczepy wywrotki", "Platformy i naczepy niskopodwoziowe"],
    },
    configurations: {
      ...
      pl: ["Opcje osi podnoszonej i skrętnej", "Warianty XL code i wzmocnionej podłogi", "Ściany stalowe i aluminiowe"],
    },
    typicalSpecs: {
      ...
      pl: ["Układ 3-osowy", "Systemy hamulców tarczowych", "Zawieszenie BPW lub SAF", "Kluczowe parametry techniczne"],
    },
  },
  {
    id: "lamberet",
    ...
    tagline: {
      ...
      pl: "Naczepy chłodnicze i izotermiczne do logistyki w kontrolowanej temperaturze.",
    },
    highlights: {
      ...
      pl: ["Chłodnia", "Multi-temp", "Izotermiczny"],
    },
    overview: {
      ...
      pl: "Lamberet specjalizuje się w rozwiązaniach transportu chłodniczego. Pracujemy z naczepami jedno- i wielotemperaturowymi odpowiednimi dla żywności, farmaceutyków i logistyki cold chain.",
    },
    bodyTypes: {
      ...
      pl: ["Chłodnie jednokomorowe", "Naczepy wielotemperaturowe", "Izotermiczne naczepy do ładunków suchych"],
    },
    configurations: {
      ...
      pl: ["Agregaty Carrier, Thermo King lub Daikin", "Oś podnoszona i winda załadowcza", "Telematyka i monitoring temperatury"],
    },
    typicalSpecs: {
      ...
      pl: ["Układ chłodniczy 3-osowy", "Konfiguracja pod transport temperaturowy", "Izolowana podłoga i ściany", "Opcje agregatu chłodniczego przed przekazaniem"],
    },
  },
];
