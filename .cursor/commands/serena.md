...
1. **Активуй проєкт:** `call_mcp_tool` → server `user-serena`, tool `activate_project`, args `{"project": "d:\\Project\\mtruck\\mtrucklending"}`
2. Проєкт: `mtrucklending` (шлях: `d:\Project\mtruck\mtrucklending`)

## Доступні інструменти (активні)

| Інструмент | Призначення |
|------------|-------------|
| `activate_project` | Активація проєкту (mtrucklending) |
